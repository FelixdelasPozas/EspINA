...
namespace EspINA
{
  ...
  //------------------------------------------------------------------------
  void EditorToolBarSettings::setBrushRadius(int r)
  {
    QSettings settings(CESVIMA, ESPINA);
  ...
  //------------------------------------------------------------------------
  void EditorToolBarSettings::setErodeRadius(int r)
  {
    QSettings settings(CESVIMA, ESPINA);
  ...
  //------------------------------------------------------------------------
  void EditorToolBarSettings::setDilateRadius(int r)
  {
    QSettings settings(CESVIMA, ESPINA);
  ...
  //------------------------------------------------------------------------
  void EditorToolBarSettings::setOpenRadius(int r)
  {
    QSettings settings(CESVIMA, ESPINA);
  ...
  //------------------------------------------------------------------------
  void EditorToolBarSettings::setCloseRadius(int r)
  {
    QSettings settings(CESVIMA, ESPINA);
