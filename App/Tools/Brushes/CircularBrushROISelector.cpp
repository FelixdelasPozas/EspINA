...
namespace EspINA
{
  ...
  //----------------------------------------------------------------------------
  bool CircularBrushROISelector::filterEvent(QEvent* e, RenderView* view)
  {
  ...
  //----------------------------------------------------------------------------
  void CircularBrushROISelector::startPreview(RenderView *view)
  {
  ...
  //----------------------------------------------------------------------------
  void CircularBrushROISelector::updatePreview(NmVector3 center, RenderView *view)
  {
    if (m_previewView == nullptr)
      startPreview(view);
