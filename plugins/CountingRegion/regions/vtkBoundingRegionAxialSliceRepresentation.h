...
#ifndef VTKBOUNDINGREGIONAXIALSLICEREPRESENTATION_H
#define VTKBOUNDINGREGIONAXIALSLICEREPRESENTATION_H

#include <regions/vtkBoundingRegionSliceRepresentation.h>


class vtkBoundingRegionAxialSliceRepresentation
: public vtkBoundingRegionSliceRepresentation
{
public:
  static vtkBoundingRegionAxialSliceRepresentation *New();

  vtkTypeMacro(vtkBoundingRegionAxialSliceRepresentation,
...
protected:
  explicit vtkBoundingRegionAxialSliceRepresentation(){}

private:
  vtkBoundingRegionAxialSliceRepresentation(const vtkBoundingRegionAxialSliceRepresentation&);  //Not implemented
  void operator=(const vtkBoundingRegionAxialSliceRepresentation&);  //Not implemented
};

#endif // VTKBOUNDINGREGIONAXIALSLICEREPRESENTATION_H
