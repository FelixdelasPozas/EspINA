/*=========================================================================
  ...
  Module:    vtkRectangularBoundingRegionWidget.h
...
=========================================================================*/
// .NAME vtkRectangularBoundingRegionWidget - 3D widget for manipulating a box
// .SECTION Description
// This 3D widget interacts with a vtkRectangularBoundingRegionRepresentation class (i.e., it
...
// object rotation or scaling. A nice feature of vtkRectangularBoundingRegionWidget, like any 3D
// widget, will work with the current interactor style. That is, if
// vtkRectangularBoundingRegionWidget does not handle an event, then all other registered
// observers (including the interactor style) have an opportunity to process
// the event. Otherwise, the vtkBoxWidget will terminate the processing of
// the event that it handles.
//
// To use this widget, you generally pair it with a vtkRectangularBoundingRegionRepresentation
...
// into the vtkRectangularBoundingRegionWidget's widget events:
// <pre>
...
// </pre>
//
// In turn, when these widget events are processed, the vtkRectangularBoundingRegionWidget
...
// 
// This class, and the affiliated vtkRectangularBoundingRegionRepresentation, are second generation
// VTK widgets. An earlier version of this functionality was defined in the
// class vtkBoxWidget.

// .SECTION See Also
// vtkRectangularBoundingRegionRepresentation vtkBoxWidget

#ifndef __vtkRectangularBoundingRegionWidget_h
#define __vtkRectangularBoundingRegionWidget_h
...
class VTK_WIDGETS_EXPORT vtkRectangularBoundingRegionWidget : public vtkAbstractWidget
{
public:
  // Description:
