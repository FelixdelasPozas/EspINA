...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[LO,LE]{\includegraphics[scale=0.29]{logo-cajal}}
\fancyfoot[CO,CE]{\thepage}
\fancyfoot[RO,RE]{\includegraphics[scale=0.1]{logo-cesvima}}
...
%P O R T A D A
\author{Jorge Peña Pastor \and Félix de las Pozas Álvarez}
