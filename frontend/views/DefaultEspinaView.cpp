...
void DefaultEspinaView::createViewMenu(QMenu* menu)
{
  ...
  connect(showRuler, SIGNAL(toggled(bool)), this, SLOT(setRulerVisibility(bool)));
  ...
  connect(showThumbnail, SIGNAL(toggled(bool)), this, SLOT(showThumbnail(bool)));
  ...
  connect(fitToSlices, SIGNAL(toggled(bool)), this, SLOT(setFitToSlices(bool)));
}
