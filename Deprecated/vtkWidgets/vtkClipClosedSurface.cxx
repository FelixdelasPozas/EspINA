...
//----------------------------------------------------------------------------
// Borrow two routines from vtkContourToPolygonFilter
class vtkContourToPolygonFilterToClipClosedSurfaceFriendship
{
public:
  ...
  static int TriangulatePolygon(
    ...
    vtkIdList *tmpIdList)
  {
  return vtkContourToPolygonFilter::TriangulatePolygon(
    polygon, points, triangles,
    tmpCellArray, tmpPolygon, tmpIdList);
  }
  ...
  static int MakePolysFromContours(
    ...
    vtkIdList *tmpIdList)
  {
  return vtkContourToPolygonFilter::MakePolysFromContours(
