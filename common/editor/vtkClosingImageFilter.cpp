#include "vtkClosingImageFilter.h"
...
vtkStandardNewMacro(vtkClosingImageFilter);

const unsigned int LABEL_VALUE = 255;

vtkClosingImageFilter::vtkClosingImageFilter()
: Radius(3)
{
...
/*
  ...
  vtkDebugMacro(<< "Compute Image Closing");
  typedef itk::BinaryBallStructuringElement<ImageType::PixelType, 3> StructuringElementType;
  typedef itk::BinaryMorphologicalClosingImageFilter<ImageType, ImageType, StructuringElementType> bmcifType;
