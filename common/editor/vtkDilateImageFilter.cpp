#include "vtkDilateImageFilter.h"
...
vtkStandardNewMacro(vtkDilateImageFilter);

const unsigned int LABEL_VALUE = 255;

vtkDilateImageFilter::vtkDilateImageFilter()
: Radius(3)
{
...
/*
  ...
  vtkDebugMacro(<< "Compute Image Dilate");
  typedef itk::BinaryBallStructuringElement<ImageType::PixelType, 3> StructuringElementType;
  typedef itk::DilateObjectMorphologyImageFilter<ImageType, ImageType, StructuringElementType> bmcifType;
