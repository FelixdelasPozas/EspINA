/*=========================================================================
  ...
  Module:    vtkNonRotatingBoxWidget.h
...
=========================================================================*/
// .NAME vtkNonRotatingBoxWidget - 3D widget for manipulating a box
// .SECTION Description
...
// object rotation or scaling. A nice feature of vtkNonRotatingBoxWidget, like any 3D
// widget, will work with the current interactor style. That is, if
// vtkNonRotatingBoxWidget does not handle an event, then all other registered
...
// into the vtkNonRotatingBoxWidget's widget events:
// <pre>
...
// </pre>
//
// In turn, when these widget events are processed, the vtkNonRotatingBoxWidget
...
public:
  ...
  static vtkNonRotatingBoxWidget *New();

  // Description:
  // Standard class methods for type information and printing.
  vtkTypeMacro(vtkNonRotatingBoxWidget,vtkAbstractWidget);
