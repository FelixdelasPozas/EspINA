...
#ifndef VTKSLICEVIEW_H
#define VTKSLICEVIEW_H
...
class VTK_EXPORT vtkSliceView : public vtkRenderView
{
public:
    enum VIEW_PLANE
    {
    ...
    static vtkSliceView* New();
    vtkTypeMacro ( vtkSliceView, vtkRenderView );
    ...
    // Reimplemented to update overview vtkRenderView behavior
    void ResetCamera();
...
private:
    vtkSliceView ( const vtkSliceView& ); // Not implemented
    void operator= ( const vtkSliceView& ); // Not implemented
