  ...
  namespace Core
  {
    ...
    : public QObject
    {
      public:
        ...
        class InformationKey
        {
          public:
            ...
            bool operator<(const InformationKey &rhs) const
            { return (extension() <  rhs.extension()) || (extension() == rhs.extension() && value() < rhs.value()); }
      ...
      public:
         ...
         *
         * NOTE: the data file names musn't have the path included, just
         *       the name as they are adapted by the extended item. They are not
         *       'Persistent' objects.
         *
         */
      ...
      protected:
        T                *m_extendedItem; /** item this extension belongs to. */
        mutable InfoCache m_infoCache;    /** data cache of the extension.    */

      private:
        mutable QReadWriteLock m_lock;    /** extension information lock.     */
    };
