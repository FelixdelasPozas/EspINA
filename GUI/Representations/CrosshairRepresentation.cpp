...
namespace EspINA
{
  ...
  //-----------------------------------------------------------------------------
  void CrosshairRepresentation::setVisible(bool visible)
  {
  ...
  //-----------------------------------------------------------------------------
  GraphicalRepresentationSPtr CrosshairRepresentation::clone(VolumeView *view)
  {
    CrosshairRepresentation *rep = new CrosshairRepresentation(m_data, view);
