...
// 
// //-----------------------------------------------------------------------------
// void RenderView::setViewType(PlaneType plane)
// {
//   m_plane = plane;
// }
// 
// //-----------------------------------------------------------------------------
// PlaneType RenderView::getViewType()
// {
//   return m_plane;
// }
// 
// //-----------------------------------------------------------------------------
// void RenderView::addSegmentation(SegmentationPtr seg)
// {
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::removeSegmentation(SegmentationPtr seg)
// {
//   Q_ASSERT(m_segmentationStates.contains(seg));
// 
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::addChannel(ChannelPtr channel)
// {
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::removeChannel(ChannelPtr channel)
// {
//   Q_ASSERT(m_channelStates.contains(channel));
// 
...
// 
// //-----------------------------------------------------------------------------
// bool RenderView::updateChannelRepresentation(ChannelPtr channel, bool render)
// {
//   if (!isVisible())
//     return false;
// 
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::updateChannelRepresentations(ChannelList list)
// {
//   if (isVisible())
//   {
...
// 
// //-----------------------------------------------------------------------------
// bool RenderView::updateSegmentationRepresentation(SegmentationPtr seg, bool render)
// {
//   if (!isVisible())
//     return false;
// 
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::updateSegmentationRepresentations(SegmentationList list)
// {
//   if (isVisible())
//   {
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::updateSelection(ViewManager::Selection selection, bool render)
// {
//   updateSegmentationRepresentations();
//   if (render)
//     updateView();
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::removeGraphicalRepresentations(ChannelState &state)
// {
...
// 
// //-----------------------------------------------------------------------------
// void RenderView::removeGraphicalRepresentations(SegmentationState &state)
// {
